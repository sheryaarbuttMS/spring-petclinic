...
```
curl "http://localhost:8080/demo.zip?iactool=TERRAFORM&region=japaneast&application=APP_SERVICE.standard&runtime=SPRING&database=NONE.free&gitops=true" | tar -xzvf -
```
